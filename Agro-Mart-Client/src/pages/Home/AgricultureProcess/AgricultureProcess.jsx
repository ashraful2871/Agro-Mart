...
const AgricultureProcess = () => {
  const steps = [
    {
      ...
      description: "When you work with us, you’ll see that absolute conditions is our priority.",
  ...
  return (
    <section className="relative">
      <div className="container mx-auto flex flex-col lg:flex-row h-[1650px] md:h-fit">
        ...
        <div className="lg:w-1/2 lg:pl-12 ">
          <h3 className="text-green-600 font-bold uppercase text-sm">Work Process</h3>
          <h2 className="text-4xl font-bold text-gray-800 mt-2">The Agriculture Process</h2>
          ...
          {/* Process Steps */}
          <div className="mt-8 gap-6 absolute z-10 max-w-6xl mx-auto
          ...
          lg:grid-cols-4 lg:bottom-10 lg:right-28 "> 
            {steps.map((step) => (
              <div key={step.id} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                <span className="text-gray-300 text-5xl font-bold">{step.id}</span>
