  ...
  const orderData = [
    {
      ...
      title: t("dashboard.order_cards.total_order"),
    ...
    },
    {
      ...
      title: t("dashboard.order_cards.orders_pending"),
      value:
        orderStats?.stats?.find((item) => item._id === "Pending")
          ?.totalOrders || 0,
      extra: `($${
        orderStats?.stats?.find((item) => item._id === "Pending")
          ?.totalAmount || 0
    ...
    },
    {
      ...
      title: t("dashboard.order_cards.orders_processing"),
      value:
        orderStats?.stats?.find((item) => item._id === "Processing")
          ?.totalOrders || 0,
    ...
    },
    {
      ...
      title: t("dashboard.order_cards.orders_delivered"),
      value:
        orderStats?.stats?.find((item) => item._id === "Delivered")
          ?.totalOrders || 0,
