    ...
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/dashboard/product/${id}`
        );
      ...
      <div className="card lg:card-side bg-base-100 shadow-sm">
        ...
        <div className="card-body w-full mx-auto my-8 p-6 bg-white border border-gray-200 rounded-lg shadow-sm ml-7">
          ...
          <div className="mt-4 space-x-4 flex gap-7">
            <a
              href="#"
              className="hover:text-green-700 hover:underline flex  gap-2"
            >
            ...
            <a
              href="#"
              className="hover:text-green-700 hover:underline flex justify-end gap-2"
            >
              <span className="my-auto">
                <IoMdGitCompare />
              </span>{" "}
          ...
          <div className="flex justify-between mt-6 bg-gray-100 py-5 px-7 lg:px-20 rounded-xl">
            <img
              src="https://i.ibb.co.com/23ncVSv0/card-11378186.png"
              alt="Visa"
              className="w-12 h-auto"
            />
            <img
              src="https://i.ibb.co.com/84DHynxv/logo-14082995.png"
              alt="Mastercard"
              className="w-12 h-auto"
            />
            <img
              src="https://i.ibb.co.com/d04xmJ6g/parking-card-1367193.png"
              alt="PayPal"
              className="w-12 h-auto"
            />
            <img
              src="https://i.ibb.co.com/XZrbNTzp/google-pay-6124998.png"
              alt="Google Pay"
              className="w-12 h-auto"
            />
          </div>
