    ...
    <div className="bg-[#e1f178] mt-6">
      <div className="w-10/12 mx-auto flex flex-col md:flex-row justify-between gap-10">
        ...
        <div className="bg-green-700 p-7 text-white rounded-b-xl">
          ...
          <p className="my-2">
            Sign up to our newslatter & event right now to be updated
          </p>
          <input
            type="email"
            placeholder="Enter your email address"
            className="p-4 w-full rounded-xl bg-purple-100"
          />
          <br />
          <button className="p-4 my-2 w-full rounded-xl bg-yellow-300 text-black font-bold">
            Subscribe
          </button>
        </div>
        ...
        <div>
          ...
          <div className="mb-2 flex flex-col md:flex-row justify-between">
            ...
            <div className=" flex flex-col justify-center">
              <h3>
                <span className="text-4xl font-bold text-green-700 font-syne">
                  Agro
                </span>
                <span className="text-4xl font-bold text-yellow-400 font-syne">
                  Mart
                </span>
              </h3>
              <p className="max-w-96">
                It's a platform enables farmers to sell agricultural products,
                manage inventory, and process orders while providing consumers
                with fresh farm produce at fair prices.
              </p>
            </div>
            {/* image */}
            <div>
              <img
                src="https://i.ibb.co.com/ZvhdCD1/footer-avatar.png"
                alt=""
                className="w-64"
              />
            </div>
